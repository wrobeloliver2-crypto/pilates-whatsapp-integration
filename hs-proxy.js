const HUBSPOT_TOKEN = "CiRldTEtZjQ5ZC00YjlmLTQzMzktYTk5Zi01ZmNkMzEwZWI4NjAQ7aicRhiB784oKhkABeaRgrYCFM1yIfHMm9ZYPhYk-8qZdcsiSgNldTE";
...
exports.handler = async (event) => {
  ...
  try {
    ...
    const searchRes = await fetch("https://api.hubapi.com/crm/v3/objects/contacts/search", {
      ...
      body: JSON.stringify({
        filterGroups,
        properties: ["firstname","lastname","email","phone","mobilephone","lifecyclestage","hubspot_owner_id","notes_last_updated"],
      }),
    });
